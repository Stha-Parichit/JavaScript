...
console.log(smtng("is better than nothing."))
...
//Given two numbers, if the sum of both numbers is less than 100 then return true. Otherwise return false.
function check(i,j){
    if ((i+j)<100){
        return true;
    } else {
